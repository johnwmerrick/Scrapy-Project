...
class glassdoor_spider(scrapy.Spider):
    ...
    def parse(self, response):
        results_url_list = ['https://www.glassdoor.com/Job/san-francisco-data-scientist-jobs-SRCH_IL.0,13_IC1147401_KO14,28.htm']
        for i in range(2, 34):
            results_url_list.append('https://www.glassdoor.com/Job/san-francisco-data-scientist-jobs-SRCH_IL.0,13_IC1147401_KO14,28_IP'+str(i)+'.htm')
