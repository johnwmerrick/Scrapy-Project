...
class glassdoor_spider(scrapy.Spider):
    ...
    start_urls = ['https://www.glassdoor.com/Job/boston-data-scientist-jobs-SRCH_IL.0,6_IC1154532_KO7,21.htm']

    def parse(self, response):
        results_url_list = ['https://www.glassdoor.com/Job/boston-data-scientist-jobs-SRCH_IL.0,6_IC1154532_KO7,21.htm']
        for i in range(2, 33):
            results_url_list.append('https://www.glassdoor.com/Job/boston-data-scientist-jobs-SRCH_IL.0,6_IC1154532_KO7,21_IP'+str(i)+'.htm')
