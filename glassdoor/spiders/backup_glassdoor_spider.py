...
class glassdoor_spider(scrapy.Spider):
    ...
    start_urls = ['https://www.glassdoor.com/Job/los-angeles-data-scientist-jobs-SRCH_IL.0,11_IC1146821_KO12,26.htm']

    def parse(self, response):
        results_url_list = ['https://www.glassdoor.com/Job/los-angeles-data-scientist-jobs-SRCH_IL.0,11_IC1146821_KO12,26.htm']
        for i in range(2, 32):
            results_url_list.append('https://www.glassdoor.com/Job/los-angeles-data-scientist-jobs-SRCH_IL.0,11_IC1146821_KO12,26_IP'+str(i)+'.htm')
