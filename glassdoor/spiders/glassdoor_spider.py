...
class glassdoor_spider(scrapy.Spider):
    ...
    start_urls = ['https://www.glassdoor.com/Job/atlanta-data-scientist-jobs-SRCH_IL.0,7_IC1155583_KO8,22.htm']

    def parse(self, response):
        results_url_list = ['https://www.glassdoor.com/Job/atlanta-data-scientist-jobs-SRCH_IL.0,7_IC1155583_KO8,22.htm']
        for i in range(2, 21):
            results_url_list.append('https://www.glassdoor.com/Job/atlanta-data-scientist-jobs-SRCH_IL.0,7_IC1155583_KO8,22_IP'+str(i)+'.htm')
